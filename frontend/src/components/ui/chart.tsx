...
interface ChartTooltipContentProps 
  extends Omit<React.ComponentProps<typeof RechartsPrimitive.Tooltip>, 'content' | 'formatter' | 'labelFormatter'>,
  ...
  formatter?: (
    ...
    index: number,
    payload: Record<string, unknown>
  ) => React.ReactNode | [React.ReactNode, string] | [React.ReactNode, string, Record<string, unknown>]
  color?: string

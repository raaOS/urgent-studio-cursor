-- Real Products Data for Urgent Studio
...
-- Insert real 19 products from frontend
INSERT INTO products (id, name, description, price, category, image_url, features, delivery_time, revisions, popular, created_at, updated_at) VALUES
...
SELECT id, name, price, popular FROM products ORDER BY id;